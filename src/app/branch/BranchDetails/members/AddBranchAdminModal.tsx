                  ...
                  users.map((u) => {
                    ...
                    return (
                      <div
                        ...
                        className={`flex cursor-pointer items-center justify-between gap-3 rounded-lg border p-2.5 transition-all select-none ${
                          isSelected
                            ? "border-blue-500 bg-blue-50/90 shadow-2xs ring-1 ring-blue-500"
